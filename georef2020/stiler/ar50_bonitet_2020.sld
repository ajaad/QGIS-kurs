      ...
      <se:FeatureTypeStyle>
          ...
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:And>
              <ogc:PropertyIsEqualTo>
                <ogc:PropertyName>arealtype</ogc:PropertyName>
                <ogc:Literal>20</ogc:Literal>
              </ogc:PropertyIsEqualTo>
              <ogc:PropertyIsNotEqualTo>
                <ogc:PropertyName>jordbruk</ogc:PropertyName>
        ...
        <se:Rule>
          ...
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:And>
              ...
              <ogc:PropertyIsEqualTo>
                <ogc:PropertyName>skogbonitet</ogc:PropertyName>
        ...
        <se:Rule>
          ...
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:And>
              ...
              <ogc:PropertyIsEqualTo>
                <ogc:PropertyName>vegetasjonsdekke</ogc:PropertyName>
        ...
        <se:Rule>
          ...
          <se:Description>
            ...
            <se:Abstract>arealtype = 60 AND treslag != 39</se:Abstract>
          </se:Description>
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:And>
              <ogc:PropertyIsEqualTo>
              ...
              <ogc:PropertyIsNotEqualTo>
                <ogc:PropertyName>treslag</ogc:PropertyName>
